...
public class StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println(str1.toUpperCase()); //1
        System.out.println(str1.toLowerCase()); //2

        // 2. Equality of String
        System.out.println(str1.equals(str2)); // true //3
        System.out.println(str1.equals(str3)); // false//4

        // 3. Equals ignoring case
        System.out.println(str1.equalsIgnoreCase(str2)); // true //5
        System.out.println(str1.equalsIgnoreCase(str3)); // true //6

        // 4. Contains
        String str4 = "Hello Chirag, Welcome to Ebay";
        System.out.println(str4.contains(str1)); // true 7
        System.out.println(str4.toLowerCase().contains(str3.toLowerCase())); // true 8
       ...
       // System.out.println(str5.isBlank()); // true
        ...
        System.out.println(str7.substring(7,15));

        // 11. Format
        String title = "Hello %s, Welcome to %s";
        String user = "Chirag";
        String website = "Amazon";
        System.out.println(String.format(title,website,user));

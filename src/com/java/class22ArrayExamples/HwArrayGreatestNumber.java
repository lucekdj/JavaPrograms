...
public class HwArrayGreatestNumber {
    public static void main(String[] args) {
        ...
        System.out.println(bigNr(numbers,greatest));//my practice using method from line 36
        ...
        System.out.println("greatest nr is " + greatest);
...
// how to use this void method
     void MaxbigNr(int[] numbers, int greatest) { // my practice using method void ,how to use it ???

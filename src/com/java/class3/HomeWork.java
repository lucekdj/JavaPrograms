...
// 1.Arithmetic Operators
        ...
        //  8/3 =2 bo reszta 2 sie nie liczy   4/2=2   12+2=+2-3 = 16-3 =13
        System.out.println(16 * 10 / (1 + 4) / 2 * 3); // 48
        //  160/5/2*3 = 32/2*3=16*3=48
        System.out.println(2 * 4 * (3 + 4) / (2 * 3)); // 9
        // 8*7/6 =56/6=9.3 piszemy tylko 9 bo integer-liczba calkowita
        System.out.println(5 * 2 / 10 + 6);    // 7

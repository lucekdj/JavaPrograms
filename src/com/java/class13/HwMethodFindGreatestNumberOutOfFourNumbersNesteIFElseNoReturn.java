...
public class HwMethodFindGreatestNumberOutOfFourNumbersNesteIFElseNoReturn {
    public static void main(String[] args) {
        ...
        findGreatestOf4(num1, num2, num3 ,num4 );
    ...
    static void findGreatestOf4(int a1, int b2, int c3, int d4) {

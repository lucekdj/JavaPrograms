...
Try to brainstorm and create a logic, use pen and paper to write
down what you do and find the next step, You can also work in a group of 3 to 4 for the brainstorming
Example
...
public class Hw1SumOfEachColumn {
